function selectAnnotator(color) {

    console.log("Chiamata a selectAnnotator() --> " + color);
    ...
    annotations = document.getElementsByClassName(color);
    buttons = document.getElementsByClassName('btn' + color);
    var i;
